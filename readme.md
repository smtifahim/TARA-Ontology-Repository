...
For the ontology directory structure, base file descriptions, and generated file listings, see the **[TARA Acupoints Ontology readme](./ontology-files/readme.md)**.
