...
| [generated/distribution](generated/distribution/) | Ontology files generated by the distribution pipeline               |
| [generated/archived](generated/archived/)         | Archived releases of the ontology                                   |
...
| [tara-imported-anatomical-terms.ttl](base/tara-imported-anatomical-terms.ttl) | Aggregated import of anatomical terms from the`imported-terms/` subdirectory        |
...
All generated Turtle files are produced by the [ontology generator pipeline](../ontology-generator) and written to [`generated/ttl/`](generated/ttl/). For the full file descriptions, version history, and archived releases, see the **[Generated Ontology Files readme](generated/distribution/readme.md)**. The ontology is organized in four layers, each building on the one below it:
