...
**Without BFO Upper Ontology (`no-bfo-upper/`)**
...
* ```
  ...
  For TARA Annotation Properties: e.g., tara-ap:hasGeneralSurfaceLocation; tara-ap:hasSpecificReferenceLocation, etc. 
  @prefix tara-ap: <http://purl.org/tara/ontology/annotation-property/> .

  For TARA Object Properties: e.g., tara-op:hasGeneralSurfaceLocation; tara-op:hasSpecificReferenceLocation, etc.
  @prefix tara-op: <http://purl.org/tara/ontology/object-property/> .

  For TARA Articles Knowledgebase metadata annotations: e.g., tara-kb:hasArticleTitle; tara-kb:hasListedAcupoints, tara-kb:hasControlGroupsDetails, etc.  
...
* `kb_terms_mapping/`: Added the automated term-mapping scripts that produces the mappings of Elicit extracted acupoints and conditions:
